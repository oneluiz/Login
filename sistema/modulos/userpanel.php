<div id="service">
	<ul class="service-bar">
		...
		?>
		<li class="service-cell service-welcome">
			<a href="<?php echo ACCOUNT_URL ?>login">Log in</a> or <a href="<?php echo ACCOUNT_URL ?>register">Create an Account</a>
		</li>
		<?php
		}
		?>
			...
			<div class="support-menu" id="support-menu" style="display:none;">
				<div class="support-primary">
					<ul class="support-nav">
						...
						View your active tickets (login required). </a>
						</li>
					</ul>
					<span class="clear">
					<!-- -->
		...
		<div class="explore-menu" id="explore-menu" style="display:none;">
			<div class="explore-primary">
				<ul class="explore-nav">
					<li>
					<a href="<?php echo BASE_URL ?>" tabindex="55" data-action="Explore - Flame.net Home"> <strong class="explore-caption">Flame.net Home</strong>
					</a>
					</li>
					<li>
					<a href="<?php echo BASE_URL ?>shop/" tabindex="55" data-action="Explore - Shop"> <strong class="explore-caption">Shop</strong>
					</a>
					</li>
					<li>
					<a href="<?php echo ACCOUNT_URL ?>management/" tabindex="55" data-action="Explore - Account"> <strong class="explore-caption">Account</strong>
					</a>
					</li>
					<li>
					<a href="<?php echo BASE_URL ?>support/" tabindex="55" data-action="Explore - Support"> <strong class="explore-caption">Support</strong>
					</a>
					</li>
				</ul>
