...
<?php include(__MODULOCUENTA__.'menu.php'); ?>
<!--main content start-->
...
<!--main content end-->
<?php include(__MODULOCUENTA__.'barra-estado.php'); ?>
</section>
<!-- Coloque js al final del documento para que las páginas se cargan más rápido -->
<!--Core js-->
